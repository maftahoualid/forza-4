...
server_functions_obj:
	gcc -g3 -c -Wall -Wextra server_functions.c -o server_functions.obj
server_exe: server_obj server_functions_obj shared_functions
...
client_functions_obj:
	gcc -g3 -c -Wall -Wextra client_functions.c -o client_functions.obj
client_exe: client_obj client_functions_obj shared_functions
